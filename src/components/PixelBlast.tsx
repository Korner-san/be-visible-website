  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const onContextRestored = () => {
        console.info('PixelBlast: WebGL context restored');
        // Re-initialization will be handled by the next effect run
        // or we can just let it be. Reloading is too aggressive.
      };
    ...
    return () => {
      ...
      // We need the original function references to remove them properly
      // but since they are defined inside the effect, we'll just let the browser
      // handle it or move them out if we really need to.
      // For now, we'll just ensure the renderer is disposed.
